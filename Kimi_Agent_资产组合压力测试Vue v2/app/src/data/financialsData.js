...
export const ratioTableData = [
    { name: '流動比率', current: '185%', prev: '172%', change: '+13pp', trend: 'up' },
    { name: '速動比率', current: '142%', prev: '135%', change: '+7pp', trend: 'up' },
    { name: '負債比率', current: '38.5%', prev: '41.2%', change: '-2.7pp', trend: 'down' },
    { name: '利息保障倍數', current: '12.4x', prev: '10.8x', change: '+1.6x', trend: 'up' },
    { name: '資產報酬率 ROA', current: '14.2%', prev: '13.5%', change: '+0.7pp', trend: 'up' },
    { name: '存貨周轉天數', current: '45天', prev: '52天', change: '-7天', trend: 'up' },
    { name: '應收帳款周轉天數', current: '38天', prev: '42天', change: '-4天', trend: 'up' },
];
