...
export const riskData = {
  scatter: [
    ...
    { x: 18, y: 12, label: '0050 元大台灣50' },
    { x: 20, y: 8, label: '2317 鴻海' },
    { x: 8, y: 6, label: '00878 ETF' },
    { x: 12, y: 4, label: '00679B 債券' },
    { x: 15, y: 10, label: '投組整體' },
  ],
  drawdown: {
    labels: ['1月', '2月', '3月', '4月', '5月', '6月', '7月', '8月', '9月', '10月', '11月', '12月'],
...
export const scenarioData = [
  { name: '市場崩盤', impact: '-28.5%', probability: '低', description: '全球金融危機導致市場大幅下跌' },
  { name: '升息', impact: '-12.3%', probability: '中', description: '央行連續升息影響資產價格' },
  { name: '科技反彈', impact: '+22.1%', probability: '高', description: 'AI 與科技產業帶動成長' },
]
