...
export const scenarioData = [
  { name: '市場崩跌', impact: '-28.5%', probability: 'Low', description: '全球金融危機，台股下跌 30%' },
  { name: '利率上升', impact: '-12.3%', probability: 'Medium', description: 'Fed 升息 200bp，債券下跌' },
  { name: '科技反彈', impact: '+22.1%', probability: 'High', description: 'AI 需求帶動科技股上漲' },
]
