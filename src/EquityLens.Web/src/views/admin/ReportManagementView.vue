...
<template>
  <main class="prestige-section prestige-fade admin-view">
    <div class="prestige-section-head">
      <div>
        <p class="prestige-label view-eyebrow">{{ t('admin.reports.titleEn') }}</p>
        <h1 class="prestige-section-title">{{ t('admin.reports.title') }}</h1>
      </div>
    ...
    <div class="prestige-empty">
      <NEmpty :description="t('admin.reports.emptyTitle')">
        <template #extra>
          <NButton class="empty-btn">{{ t('admin.reports.learnMore') }}</NButton>
        </template>
      </NEmpty>
    </div>
  </main>
