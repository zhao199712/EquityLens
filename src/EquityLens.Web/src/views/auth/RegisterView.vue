      ...
      <div class="auth-form-wrapper">
        <div class="auth-form">
          <div class="auth-form-header">
            <span class="prestige-label">New Account</span>
          ...
          <form class="auth-fields" @submit.prevent="handleRegister">
            <div class="auth-field">
              <label class="auth-field-label">{{ t('auth.register.displayName') }}</label>
              <input
                v-model="displayName"
                type="text"
            ...
            <div class="auth-field">
              <label class="auth-field-label">{{ t('auth.register.email') }}</label>
              <input
                v-model="email"
                type="email"
                class="prestige-input"
            ...
            <div class="auth-field">
              <label class="auth-field-label">{{ t('auth.register.password') }}</label>
              <input
                v-model="password"
                type="password"
                class="prestige-input"
            ...
            <div class="auth-field">
              <label class="auth-field-label">{{ t('auth.register.confirmPassword') }}</label>
              <input
