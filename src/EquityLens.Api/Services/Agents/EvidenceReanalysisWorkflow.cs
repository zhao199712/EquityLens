...
public sealed class BuildAnalysisContextNodeHandler : IAgentNodeHandler
{
    ...
    public Task ExecuteAsync(AgentNodeExecutionContext context, CancellationToken cancellationToken = default)
    {
        var board = EvidenceReanalysisBoard.Parse(context.Run); var output = EvidenceReanalysisBoard.Required<EvidenceRemediationOutput>(board, AgentBlackboardKeys.EvidenceRemediationOutput); var packet = EvidenceReanalysisBoard.Required<RemediatedEvidencePacket>(board, AgentBlackboardKeys.RemediatedEvidencePacket); var reasons = EvidenceReanalysisBoard.Required<List<string>>(board, AgentBlackboardKeys.ReanalysisReasons);
