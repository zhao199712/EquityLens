...
public sealed class AgentWorkflowCatalog : IAgentWorkflowCatalog
{
    ...
    [
        N(FeedbackRevisionNodeTypes.LoadContext, "載入使用者修正內容", "載入父研究、原答案、引用、Critic 與使用者 feedback。", "Input", "ReadOnly", [AgentBlackboardKeys.ParentAgentRunId], [AgentBlackboardKeys.ParentResearchRunId, AgentBlackboardKeys.ResearchRunId, AgentBlackboardKeys.ResearchRequest, AgentBlackboardKeys.Ticker, AgentBlackboardKeys.Question, AgentBlackboardKeys.Answer, AgentBlackboardKeys.OriginalAnswer, AgentBlackboardKeys.ResearchIntent, AgentBlackboardKeys.InitialEvidence, AgentBlackboardKeys.SelectedEvidence, AgentBlackboardKeys.Citations, AgentBlackboardKeys.Candidates, AgentBlackboardKeys.FeedbackComment, AgentBlackboardKeys.FeedbackIntent, AgentBlackboardKeys.RevisionContext], [FeedbackRevisionNodeTypes.ValidateContext]),
        N(FeedbackRevisionNodeTypes.ValidateContext, "驗證修正內容", "驗證 feedback 與父子研究關聯後交由 Planner 動態組 DAG。", "Planning", "ReadOnly", [AgentBlackboardKeys.RevisionContext, AgentBlackboardKeys.FeedbackComment], [], [ResearchInvestigationNodeTypes.PlanRetrieval, ResearchInvestigationNodeTypes.DraftAnswer]),
        ...
        ,N(PortfolioDiagnosisNodeTypes.DraftDiagnosis, "撰寫投組診斷", "以已驗證的證據生成繁體中文診斷。", "Draft", "ExternalLlmRead", ["portfolioEvidencePacket"], ["portfolioDiagnosisDraft"], [HumanApprovalNodeTypes.WaitForHumanApproval])
        ...
        ,N(PortfolioDiagnosisNodeTypes.FinalizeRejectedDiagnosis, "完成遭拒絕的投組診斷", "人工拒絕診斷後記錄決策並將 run 標為失敗。", "Finalize", "WritesAgentTrace", [AgentBlackboardKeys.HumanApproval], ["finalOutput"], [])
        ...
        ,N(EvidenceRemediationNodeTypes.RetrieveEvidence, "檢索本地補充證據", "檢索本地文件；舊 workflow snapshot 可保留既有 Web fallback。", "Retrieval", "ExternalRead", [AgentBlackboardKeys.Ticker, AgentBlackboardKeys.RetrievalPlan], [AgentBlackboardKeys.RetrievedEvidence], [EvidenceRemediationNodeTypes.ExtractClaims])
        ,N(EvidenceRemediationNodeTypes.RetrieveWebEvidence, "檢索 Web 證據", "依受控 search intents 檢索候選證據；暫時性 Web 故障耗盡重試後降級為零結果。", "Retrieval", "ExternalRead", [AgentBlackboardKeys.Question, AgentBlackboardKeys.ExtractedClaims], [AgentBlackboardKeys.RetrievedEvidence], [EvidenceRemediationNodeTypes.AssessSupport])
        ,N(EvidenceRemediationNodeTypes.ExtractClaims, "擷取待驗證 Claims", "由答案擷取 claims，經品質閘門修復或 deterministic decomposition 後才供檢索使用。", "Analysis", "ExternalLlmRead", [AgentBlackboardKeys.Question, AgentBlackboardKeys.Answer, AgentBlackboardKeys.CriticFindings], [AgentBlackboardKeys.ExtractedClaims, AgentBlackboardKeys.ClaimSetValidation, AgentBlackboardKeys.RequiredResearchDimensions, AgentBlackboardKeys.MissingResearchDimensions, AgentBlackboardKeys.ClaimRepairHistory], [EvidenceRemediationNodeTypes.RetrieveWebEvidence, EvidenceRemediationNodeTypes.AssessSupport])
        ...
        ,N(ResearchInvestigationNodeTypes.Validate, "驗證研究請求", "驗證股票、來源與研究資料可用性。", "Input", "ReadOnly", [AgentBlackboardKeys.ResearchRequest], [AgentBlackboardKeys.Ticker], [ResearchInvestigationNodeTypes.DetectIntent])
        ,N(ResearchInvestigationNodeTypes.DetectIntent, "辨識研究意圖", "辨識風險、財務、展望或一般研究意圖。", "Planning", "ReadOnly", [AgentBlackboardKeys.Question], [AgentBlackboardKeys.ResearchIntent], [ResearchInvestigationNodeTypes.PlanRetrieval])
        ,N(ResearchInvestigationNodeTypes.PlanRetrieval, "規劃初始檢索", "建立首次研究檢索策略並初始化證據集合。", "Planning", "ReadOnly", [AgentBlackboardKeys.ResearchRequest, AgentBlackboardKeys.ResearchIntent], [AgentBlackboardKeys.RetrievalPlan, AgentBlackboardKeys.InitialEvidence], [ResearchInvestigationNodeTypes.RetrieveLocal, ResearchInvestigationNodeTypes.EvaluateEvidence])
        ,N(ResearchInvestigationNodeTypes.RetrieveLocal, "檢索本地研究證據", "依來源政策檢索本地文件。", "Evidence", "ExternalRead", [AgentBlackboardKeys.Ticker, AgentBlackboardKeys.RetrievalPlan], [AgentBlackboardKeys.InitialEvidence], [ResearchInvestigationNodeTypes.EvaluateEvidence])
        ,N(ResearchInvestigationNodeTypes.EvaluateEvidence, "評估 Web 能力需求", "Node Agent 只能向 Blackboard 提出 Web capability request，由 Planner 與 Validator 審核。", "Decide", "ExternalLlmRead", [AgentBlackboardKeys.InitialEvidence, AgentBlackboardKeys.ResearchRequest], [AgentBlackboardKeys.InitialEvidencePolicy, AgentBlackboardKeys.CapabilityRequestAssessment, AgentBlackboardKeys.CapabilityRequests], [ResearchInvestigationNodeTypes.RetrieveWeb, ResearchInvestigationNodeTypes.RankEvidence])
        ,N(ResearchInvestigationNodeTypes.RetrieveWeb, "檢索 Web 研究證據", "依來源政策條件式檢索 Web。", "Evidence", "ExternalRead", [AgentBlackboardKeys.InitialEvidencePolicy, AgentBlackboardKeys.Question], [AgentBlackboardKeys.InitialEvidence], [ResearchInvestigationNodeTypes.RankEvidence])
        ,N(ResearchInvestigationNodeTypes.RankEvidence, "排序與選擇研究證據", "Rerank 並選出生成答案使用的證據。", "Evidence", "ExternalRead", [AgentBlackboardKeys.InitialEvidence, AgentBlackboardKeys.ResearchIntent], [AgentBlackboardKeys.SelectedEvidence], [ResearchInvestigationNodeTypes.DraftAnswer])
        ,N(ResearchInvestigationNodeTypes.DraftAnswer, "產生研究初稿", "只使用已選證據產生附引用研究答案。", "Draft", "ExternalLlmRead", [AgentBlackboardKeys.SelectedEvidence, AgentBlackboardKeys.Question], [AgentBlackboardKeys.Answer, AgentBlackboardKeys.Citations, AgentBlackboardKeys.Candidates, AgentBlackboardKeys.ResearchRun], [CriticReviewNodeTypes.BuildEvidencePacket])
        ,N(PortfolioRiskMathNodeTypes.PrepareInputs, "準備投組風險數學輸入", "從授權的市場價格與投組資料建立可追溯數學輸入。", "Evidence", "ReadOnly", [], [AgentBlackboardKeys.MathInputs], [PortfolioRiskMathNodeTypes.Execute])
        ,N(PortfolioRiskMathNodeTypes.Execute, "執行投組風險數學", "使用已驗證 Blackboard 輸入執行 allowlisted 數學函數。", "Analyze", "ReadOnly", [AgentBlackboardKeys.MathInputs], [AgentBlackboardKeys.MathResults], [ResearchInvestigationNodeTypes.DraftAnswer, PortfolioDiagnosisNodeTypes.CalculateAttribution, PortfolioDiagnosisNodeTypes.BuildEvidencePacket])
        ,new(new AgentNodeContract(HumanApprovalNodeTypes.WaitForHumanApproval, 1, "等待人工批准", "暫停 workflow 直到審核者批准或拒絕；決策寫回 Blackboard 後由條件 Edge 分流。", "Approval", "ExternalHumanInteraction", $"{HumanApprovalNodeTypes.WaitForHumanApproval}Input", $"{HumanApprovalNodeTypes.WaitForHumanApproval}Output", [], [AgentBlackboardKeys.ApprovalRequest], [AgentBlackboardKeys.ApprovalRequest, AgentBlackboardKeys.HumanApproval], [], [PortfolioDiagnosisNodeTypes.FinalizeDiagnosis, PortfolioDiagnosisNodeTypes.FinalizeRejectedDiagnosis], new AgentNodeExecutionPolicy(120, 0), true, false, true))
    ];
    ...
    [
        ...
        ,new(AgentWorkflowTypes.PortfolioDiagnosis, "Portfolio Diagnosis", "分析投組跑輸來源與應補做風險分析。", AgentTypes.Portfolio, [PortfolioDiagnosisNodeTypes.LoadContext, PortfolioRiskMathNodeTypes.PrepareInputs, PortfolioRiskMathNodeTypes.Execute, PortfolioDiagnosisNodeTypes.CalculateAttribution, PortfolioDiagnosisNodeTypes.LoadRiskProfile, PortfolioDiagnosisNodeTypes.PrioritizeRiskAnalyses, PortfolioDiagnosisNodeTypes.BuildEvidencePacket, PortfolioDiagnosisNodeTypes.DraftDiagnosis, HumanApprovalNodeTypes.WaitForHumanApproval, PortfolioDiagnosisNodeTypes.FinalizeDiagnosis, PortfolioDiagnosisNodeTypes.FinalizeRejectedDiagnosis], [(PortfolioDiagnosisNodeTypes.LoadContext, PortfolioRiskMathNodeTypes.PrepareInputs), (PortfolioRiskMathNodeTypes.PrepareInputs, PortfolioRiskMathNodeTypes.Execute), (PortfolioRiskMathNodeTypes.Execute, PortfolioDiagnosisNodeTypes.CalculateAttribution), (PortfolioDiagnosisNodeTypes.CalculateAttribution, PortfolioDiagnosisNodeTypes.LoadRiskProfile), (PortfolioDiagnosisNodeTypes.LoadRiskProfile, PortfolioDiagnosisNodeTypes.PrioritizeRiskAnalyses), (PortfolioDiagnosisNodeTypes.PrioritizeRiskAnalyses, PortfolioDiagnosisNodeTypes.BuildEvidencePacket), (PortfolioDiagnosisNodeTypes.BuildEvidencePacket, PortfolioDiagnosisNodeTypes.DraftDiagnosis), (PortfolioDiagnosisNodeTypes.DraftDiagnosis, HumanApprovalNodeTypes.WaitForHumanApproval), (HumanApprovalNodeTypes.WaitForHumanApproval, PortfolioDiagnosisNodeTypes.FinalizeDiagnosis), (HumanApprovalNodeTypes.WaitForHumanApproval, PortfolioDiagnosisNodeTypes.FinalizeRejectedDiagnosis)])
        ...
        ,new(AgentWorkflowTypes.ResearchInvestigation, "Research Investigation", "從研究問題、證據檢索、初稿到品質審查與動態修訂的端到端流程。", AgentTypes.Research, ResearchInvestigationTypes(), ResearchInvestigationEdges())
        ,new(AgentWorkflowTypes.FeedbackRevision, "Feedback Revision", "根據使用者修正要求由 Planner 動態組合研究修訂 DAG。", AgentTypes.Research, FeedbackRevisionTypes(), [(FeedbackRevisionNodeTypes.LoadContext, FeedbackRevisionNodeTypes.ValidateContext)])
    ];
    ...
    private static IReadOnlyList<string> ResearchInvestigationTypes() => [ResearchInvestigationNodeTypes.Validate, ResearchInvestigationNodeTypes.DetectIntent, ResearchInvestigationNodeTypes.PlanRetrieval, ResearchInvestigationNodeTypes.RetrieveLocal, ResearchInvestigationNodeTypes.EvaluateEvidence, ResearchInvestigationNodeTypes.RetrieveWeb, ResearchInvestigationNodeTypes.RankEvidence, ResearchInvestigationNodeTypes.DraftAnswer, CriticReviewNodeTypes.BuildEvidencePacket, CriticReviewNodeTypes.CheckEvidence, CriticReviewNodeTypes.CritiqueAnswer, CriticReviewNodeTypes.FinalizeCriticReport];
    private static IReadOnlyList<(string From, string To)> ResearchInvestigationEdges() => ResearchInvestigationTypes().Zip(ResearchInvestigationTypes().Skip(1), (from, to) => (from, to)).ToList();
    private static IReadOnlyList<string> FeedbackRevisionTypes() => [FeedbackRevisionNodeTypes.LoadContext, FeedbackRevisionNodeTypes.ValidateContext, ..ResearchInvestigationTypes(), ..EvidenceRemediationTypes(), ..EvidenceReanalysisTypes(), DraftRevisionNodeTypes.DraftRevisedAnswer, DraftRevisionNodeTypes.FinalizeRevision, PortfolioRiskMathNodeTypes.PrepareInputs, PortfolioRiskMathNodeTypes.Execute];
