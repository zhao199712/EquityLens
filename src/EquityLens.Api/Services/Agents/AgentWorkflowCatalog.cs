...
public sealed class AgentWorkflowCatalog : IAgentWorkflowCatalog
{
    ...
    [
        ...
        ,N(ResearchInvestigationNodeTypes.EvaluateEvidence, "評估初始證據策略", "決定是否需要 Web 證據。", "Decide", "ReadOnly", [AgentBlackboardKeys.InitialEvidence, AgentBlackboardKeys.ResearchRequest], [AgentBlackboardKeys.InitialEvidencePolicy], [ResearchInvestigationNodeTypes.RetrieveWeb])
