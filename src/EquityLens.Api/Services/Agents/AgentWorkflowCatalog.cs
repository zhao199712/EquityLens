...
public sealed class AgentWorkflowCatalog : IAgentWorkflowCatalog
{
    ...
    [
        ...
        ,N(EvidenceRemediationNodeTypes.RetrieveWebEvidence, "檢索 Web 證據", "依受控 search intents 使用目前設定的 Web provider 檢索候選證據。", "Retrieval", "ExternalRead", [AgentBlackboardKeys.Question, AgentBlackboardKeys.ExtractedClaims], [AgentBlackboardKeys.RetrievedEvidence], [EvidenceRemediationNodeTypes.AssessSupport])
