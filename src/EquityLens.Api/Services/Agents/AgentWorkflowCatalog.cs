...
public sealed class AgentWorkflowCatalog : IAgentWorkflowCatalog
{
    ...
    [
        ...
        ,N(EvidenceRemediationNodeTypes.ExtractClaims, "擷取待驗證 Claims", "由答案擷取 factual claims；資料不足回答改由問題與 Critic findings 建立 investigation claims。", "Analysis", "ExternalLlmRead", [AgentBlackboardKeys.Question, AgentBlackboardKeys.Answer, AgentBlackboardKeys.CriticFindings], [AgentBlackboardKeys.ExtractedClaims], [EvidenceRemediationNodeTypes.RetrieveWebEvidence, EvidenceRemediationNodeTypes.AssessSupport])
