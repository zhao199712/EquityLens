...
BEGIN
    ...
    VALUES ('b544ff08-afd2-4e2f-b1fa-a1ead9d988d0', 'USD', 'TWD', 30.0, TIMESTAMPTZ '2026-01-01T00:00:00Z');
    INSERT INTO exchange_rate (id, source_currency, target_currency, rate, updated_at_utc)
    VALUES ('288fa2d8-93bb-43dc-9032-63bbd5b6c34b', 'TWD', 'USD', 0.033333, TIMESTAMPTZ '2026-01-01T00:00:00Z');
    END IF;
END $EF$;
